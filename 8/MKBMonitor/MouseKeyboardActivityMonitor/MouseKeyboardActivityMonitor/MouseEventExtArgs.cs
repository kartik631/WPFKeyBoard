...
namespace MouseKeyboardActivityMonitor
{
    ...
    public class MouseEventExtArgs : MouseEventArgs
    {
        ...
        internal MouseEventExtArgs(MouseButtons buttons, int clicks, MouseKeyboardActivityMonitor.WinApi.Point point, int delta, int timestamp,  bool isMouseKeyDown, bool isMouseKeyUp)
        ...
        /// 
        /// </summary>
        internal MouseKeyboardActivityMonitor.WinApi.Point Point => new MouseKeyboardActivityMonitor.WinApi.Point(X, Y);
    }
}
