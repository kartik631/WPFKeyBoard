...
namespace MouseKeyboardActivityMonitor
{
	...
	public class MouseHookListener : BaseHookListener
	{
		...
		private MouseKeyboardActivityMonitor.WinApi.Point m_PreviousPosition;
		...
		public MouseHookListener(Hooker hooker)
			: base(hooker)
		{
			m_PreviousPosition = new MouseKeyboardActivityMonitor.WinApi.Point(-1, -1);
		...
		private bool HasMoved(MouseKeyboardActivityMonitor.WinApi.Point actualPoint)
		{
